...
int main(){
    ...
    cout<<"Altri test della aggiungi"<<endl;
    n.aggiungi("A", 6);
    n.aggiungi("Z", -3); // prezzo negativo
    n.aggiungi("NOME MAGGIORE DI VENTICINQUE CARATTERI", 3); // nome troppo lungo
    cout<<n<<endl;

    cout<<"Altri test della consuma"<<endl;
    n.consuma("AA").consuma("B");
    n.consuma("F").consuma("G"); // consuma piatti inesistenti
    n.consuma("Z").consuma(""); // consuma il piatto con il prezzo negativo e quello con il nome troppo lungo
    cout<<n<<endl;
